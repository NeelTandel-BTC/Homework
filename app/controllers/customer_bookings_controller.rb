class CustomerBookingsController < ApplicationController
  ...
  def end_time
    @customer_booking.end_time =
      @customer_booking.end_time.change(
        day: @customer_booking.date.day,
        mont: @customer_booking.date.month,
        year: @customer_booking.date.year
      )
  end

  def start_time
    @customer_booking.start_time =
      @customer_booking.start_time.change(
        day: @customer_booking.date.day,
        mont: @customer_booking.date.month,
        year: @customer_booking.date.year
      )
